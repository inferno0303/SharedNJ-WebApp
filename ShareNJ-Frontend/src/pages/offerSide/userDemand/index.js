...
class UserDemand extends React.Component {
  ...
  render() {
    ...
    return (
      <div>
        <PageHeader title="商家侧查看用户需求"
                    subTitle="可以查看用户发出的需求信息"
                    extra={<Button loading={this.state.reloadDataBtnLoading} onClick={this.handleReloadData} icon={<ReloadOutlined />} type="primary">刷新</Button>}
        />
